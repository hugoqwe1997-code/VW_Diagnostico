...
function Verify-License {
    ...
    # Senha mestra VW Informatica (sem limite, sem internet, sem validade)
    if ($chave -eq "159753") {
        Write-Host "  Acesso MASTER liberado!" -ForegroundColor Green
        Write-Host ""
        Write-Host "  Titular  : VW Informatica (Admin)" -ForegroundColor White
        Write-Host "  Tipo     : Acesso mestre - sem limite" -ForegroundColor White
